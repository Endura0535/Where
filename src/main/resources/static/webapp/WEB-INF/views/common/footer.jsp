						...
						<div class="w-body-a">
							<ul class="list-unstyled">
								<li class="item-list-a"><i class="bi bi-chevron-right"></i>
									<a href="${root}/trip?type=recommend">지역별 여행지 추천</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="col-sm-12 col-md-4 section-md-t3">
				<div class="widget-a">
					...
					<div class="w-body-a">
						<ul class="list-unstyled">
							<li class="item-list-a"><i class="bi bi-chevron-right"></i>
								<a href="${root}/trip?type=hotPlace">핫플 등록</a></li>
							<li class="item-list-a"><i class="bi bi-chevron-right"></i>
								<a href="${root}/article?action=list">게시판</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="widget-a">
							...
							<div class="w-body-a">
								<ul class="list-unstyled">
									...
									<li class="item-list-a"><i class="bi bi-chevron-right"></i>
										<a href="user?action=mypage">마이페이지</a></li>
								</ul>
							</div>
						</div>
					</div>
