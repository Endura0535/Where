...
public class UserController {
	...
	@ApiOperation(value = "회원가입", notes = "회원가입 후 결과 메세지 반환.")
	@PostMapping("/regist")
	public ResponseEntity<Map<String, Object>> regist(@RequestBody User userInfo) {
		logger.debug("User............................regist user:" + userInfo);
	...
	@PostMapping("/modify")
	public ResponseEntity<Map<String, Object>> modify(User modiUser, HttpServletRequest request) {
		logger.info("User............................modify		 modiuser:" + modiUser);
		logger.debug(modiUser.toString());
		Map<String, Object> resultMap = new HashMap<>();
		HttpStatus status = null;
		
		logger.info("User............................modify		 modiuser:" + modiUser);
		
		userService.update(modiUser);
		resultMap.put("message", SUCCESS);
		status = HttpStatus.ACCEPTED;
