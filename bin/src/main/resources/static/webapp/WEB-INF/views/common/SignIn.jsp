					...
					<div class="row border border-1 p-4 rounded-4">
						<div class="col-md-12 mb-2">
							<div class="form-group">
								<label class="pb-2" for="userid">ID</label> <input type="text"
									class="form-control form-control-lg form-control-a" id="id"
						...
						<div class="col-md-12 mb-2">
							<div class="form-group">
								...
								<input
									type="password"
									class="form-control form-control-lg form-control-a" id="pw"
				...
				<div class="box-collapse-wrap form">
					...
					<div class="d-flex align-content-center justify-content-center">
						<a href="${root}/user/logout"
							class="ms-5 me-5 mt-3 md-3 text-black-50">로그아웃</a>
					</div>
				</div>
			</form>
		</div>
